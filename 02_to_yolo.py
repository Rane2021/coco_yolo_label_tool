...
LastEditTime: 2022-06-29 08:08:05
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file', default='/home/rane/2TDisk/01_Projects/04_huagong_proj/Dataset_Fanyingshi/ip142_data/train_v2_coco/annotations/instances_val2017.json', type=str, help="coco file path")
    parser.add_argument('--save_dir', default='/home/rane/2TDisk/01_Projects/04_huagong_proj/Dataset_Fanyingshi/ip142_data/train_v2_yolo/labels', type=str, help="where to save .txt labels")
